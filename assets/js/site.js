...
(function () {
  ...
  var VI = {
    ...
    "Blast & Paint": "Làm sạch & Sơn", "Surface preparation and coating.": "Chuẩn bị bề mặt và sơn phủ.",
    "Mechanical & E&I Assembly & Test": "Lắp ráp & Thử nghiệm cơ khí & E&I", "Tubing, E&I assembly and functional testing.": "Lắp đặt tubing, E&I và thử nghiệm chức năng.",
    "Delivery": "Bàn giao", "Packing and delivery.": "Đóng gói và bàn giao.",
    ...
    "Welding quality system": "Hệ thống chất lượng hàn", "Execution of steel & metal structures": "Thực hiện kết cấu thép & kim loại",
    ...
    "Quality is planned and verified from material receipt to final dispatch. We work to project-specific Inspection & Test Plans (ITPs), qualified welding procedures and independent inspection, all managed through an ERP system that delivers complete documentation and full traceability from material through production to delivery.": "Chất lượng được hoạch định và kiểm chứng từ khâu tiếp nhận vật tư đến khi xuất hàng. Chúng tôi làm việc theo Kế hoạch Kiểm tra & Thử nghiệm (ITP) riêng cho từng dự án, quy trình hàn được phê duyệt và kiểm định độc lập, tất cả được quản lý bằng hệ thống ERP mang lại hồ sơ đầy đủ và truy xuất nguồn gốc trọn vẹn từ vật liệu qua sản xuất đến giao hàng.",
    "Production planning and control through an ERP system": "Hoạch định và kiểm soát sản xuất bằng hệ thống ERP",
    "Full traceability from material through production to delivery": "Truy xuất nguồn gốc đầy đủ từ vật liệu qua sản xuất đến giao hàng",
